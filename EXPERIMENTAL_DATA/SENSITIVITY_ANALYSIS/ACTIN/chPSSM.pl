...
print " :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n";
my $start_time = time;
print"\n  ENTER THE QUERY FILENAME (IN FASTA FORMAT) : ";
chomp(my $file=<STDIN>);
my $input=$file;chomp($input);
my $output=$file;
	$output=~s/.txt/.pssm/;
	chomp($output);
...
#	print "\n\tREADING FROM FILE ..............\n";
	...
	#----- Printing of sequences after addition of U -----
#	for(my $g=1;$g<=$no_of_hits_plus_querry;$g++){
#		for(my $i=1;$i<=$seqlength_arr[0];$i++){
#			print Q $seq[$g][$i];
#		}
#		print Q "\n";
#	}
	...
	#print "\n\ttotal no.of a's in sequences=$A";
	
	for(my $i=0;$i<=19;$i++){
		if($arr1[$i]==0){$arr1[$i]=0.5;$arr2[$i]=0.5;}
	}
	
	#-------------------------------------- Probability of expected by chance 'Pc' of match and mismatch of 210 residues ---------------
#	for(my $i=0;$i<=19;$i++){
#		for(my $j=$i;$j<=19;$j++){
#			push @{$arr3[$i]},$arr1[$i]/$total_residues * $arr2[$j]/$total_residues;
#		}
...
#	}
	...
	#-----------------------------------------Frequency table for pseudocount calculation(with respect to codon bias) -------------------
		@frequency_codonbias = (
